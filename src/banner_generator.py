...
def _ghostscript_process(input_path: str, output_path: str) -> None:
    ...
    Исправляет все три ошибки валидации:
      ...
      - UnsupportedDeviceColorSpace → -sOutputICCProfile + OutputIntent
    ...
    if icc_exists:
        cmd += [
            # OutputIntent — встраивает профиль как точку выхода цвета
            # Это закрывает ошибку UnsupportedDeviceColorSpace
