...
main.py
~~~~~~~
Точка входа. Собирает ConversationHandler и запускает polling.
"""
...
def main() -> None:
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            AWAIT_LINE_COUNT: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, save_line_count_and_ask_text),
            ],
            AWAIT_TEXT_LINES: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, save_text_and_continue),
            ],
            AWAIT_POSTPRINT: [
